    ...
    if (onCreate) {
        ...
        return Promise.all(promises).then(results => {
            ...
            return clientAPI.executeAction({
                ...
                let createItem = !!(function() { try { return clientAPI.evaluateTargetPath('#Control:PartDetailsLstPkr/#SelectedValue'); } catch (exc) { return ''; } })();
                if (createItem) {
                    return clientAPI.executeAction({
                ...
                // eslint-disable-next-line brace-style
                let createCause = !!(function() { try { return clientAPI.evaluateTargetPath('#Control:CodeLstPkr/#SelectedValue'); } catch (exc) { return ''; } })();
                if (createCause) {
                    ...
                    return clientAPI.executeAction({
                        ...
                        'Properties': {
                            'Properties':
                            {
                                ...
                                'CauseText' : context.evaluateTargetPath('#Control:CauseDescription/#Value') ? context.evaluateTargetPath('#Control:CauseDescription/#Value') : '',
                                // eslint-disable-next-line brace-style
