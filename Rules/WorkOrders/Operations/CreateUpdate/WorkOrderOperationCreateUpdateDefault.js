            ...
            if (CommonLibrary.isDefined(binding.NotifNum)) {
                ...
                return EquipFLocIsAllowed(control.getPageProxy()).then(result => {
                    ...
                    if (result === true || isOnEdit) {
                        /// Set the Equipment picker using the Operation Functional Location
                        if (control.getPageProxy().binding['@odata.type'] === '#sap_mobile.MyWorkOrderOperation') {
        ...
        case 'FuncLocHierarchyExtensionControl': {
            ...
            if (CommonLibrary.isDefined(binding.NotifNum)) {
                ...
                return EquipFLocIsAllowed(control.getPageProxy()).then(result => {
                    ...
                    if (result === true || isOnEdit) {
                        /// Set the FLOC picker using the Operation Functional Location
                        if (control.getPageProxy().binding['@odata.type'] === '#sap_mobile.MyWorkOrderOperation') {
